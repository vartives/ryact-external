...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChild_1(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          BeginChild_1(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          Button_Exit(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_Buy(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Button_Info(const char* label, ImTextureID image, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Checkbox_Togle(const char* label, bool* v);
    IMGUI_API void BeginTabs(ImVec2 dummy);
    IMGUI_API bool          Tab(const char* name, ImTextureID image, const char* const sub_tabs[], int sub_tabs_count, bool selectable);
    IMGUI_API void EndTabs();

    IMGUI_API bool          checkbox_with_keybind(const char* label, const char* text_label, const char* text_description, ImTextureID image, const char* label_popup, bool* callback, int* key, int* mode, bool* value, bool* show_in_binds);
    IMGUI_API bool          Checkbox_Custom(const char* label, const char* text_label, const char* text_description, bool* v);
    IMGUI_API bool          config_selector(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Keybind(const char* label, const char* text_label, const char* text_description, int* key, bool show_label = true);
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/imgui/issues/3361
    IMGUI_API bool          SliderFloat(const char* icon_label, const char* label, const char* text_label, const char* text_description, float* v, float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    IMGUI_API bool          SliderFloat2(const char* icon_label, const char* label, float v[2], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloat3(const char* icon_label, const char* label, float v[3], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloat4(const char* icon_label, const char* label, float v[4], float v_min, float v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderAngle(const char* label, float* v_rad, float v_degrees_min = -360.0f, float v_degrees_max = +360.0f, const char* format = "%.0f deg", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt(const char* icon_label, const char* label, const char* text_label, const char* text_description, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool QuandFloat(const char* label, float* v0, float* v1, float v_min0 = 0.0f, float v_max0 = 0.0f, float v_min1 = 0.0f, float v_max1 = 0.0f, const char* format0 = "%d", const char* format1 = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool QuandInt(const char* label, int* v0, int* v1, int v_min0 = 0, int v_max0 = 0, int v_min1 = 0, int v_max1 = 0, const char* format0 = "%d", const char* format1 = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt2(const char* icon_label, const char* label, int v[2], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt3(const char* icon_label, const char* label, int v[3], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderInt4(const char* icon_label, const char* label, int v[4], int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          QuandScalar(const char* label, ImGuiDataType data_type, void* p_data0, void* p_data1, const void* p_min0, const void* p_max0, const void* p_min1, const void* p_max1, const char* format0 = "%d", const char* format1 = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalar(const char* icon_label, const char* label, const char* text_label, const char* text_description, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool HueSlider(const char* label, float col[4], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          SliderScalarN(const char* icon_label, const char* label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
